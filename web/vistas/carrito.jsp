                ...
                <div class="">                  
                    <div class="">
                        ...
                        <div class="card-footer">
                            <a href="Controlador?accion=GenerarCompra" class="">Generar Compra</a>
                            <a href="#" data-toggle="modal" data-target="#myModalPago" class="">Realizar Pago</a>
                        </div>
                    </div>
                </div>
                        </center>
                    ...
                    <div class="modal-body"> 
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-iniciar" role="tabpanel">
                                <form action="Controlador">
                                    <div class="form-group">
                                        <label>Targeta de credito</label>
